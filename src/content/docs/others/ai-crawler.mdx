...
- Public agent guide exports: [agent-guides/skills.md](../../agent-guides/skills.md), [agent-guides/tasks.md](../../agent-guides/tasks.md), and [agent-guides/content-authoring.md](../../agent-guides/content-authoring.md).
